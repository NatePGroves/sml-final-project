...
# Find states with < 10 occurrences
...
```
Here, we see that the full model has a lower delta than the stepwise selection model,
a surprising result, but pointing to the idea that the full model might capture more information.
